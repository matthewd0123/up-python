...
class TestUPayloadBuilder(unittest.TestCase):
    ...
    def _assert_pack_to_any(self, expected: Message, actual: UPayload):
        self.assertEqual(UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF_WRAPPED_IN_ANY,  actual.format)
    ...
    def test_pack_to_any_given_method_returns_upayload(self):
        ...
        msg: Message = Method(name="name", request_type_url="request_type_url", response_type_url="response_type_url", request_streaming=None)
        any_message = Any()
        any_message.Pack(msg)
    ...
    def test_unpack_given_pack_returns_boolvalue(self):
        ...
        upayload: UPayload = UPayload(format=UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF, value=original_msg.SerializeToString())
    ...
    def test_unpack_given_upayload_proto_returns_method(self):
        ...
        original_msg: Message = Method(name="name", request_type_url="request_type_url", response_type_url="response_type_url", request_streaming=None)
        upayload: UPayload = UPayload(format=UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF, value=original_msg.SerializeToString())
    ...
    def test_unpack_given_any_wrapped_upayload_returns_boolvalue(self):
        ...
        upayload: UPayload = UPayload(format=UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF_WRAPPED_IN_ANY, value=any_message.SerializeToString())
    ...
    def test_unpack_given_wrong_format_returns_none(self):
        ...
        upayload: UPayload = UPayload(format=UPayloadFormat.UPAYLOAD_FORMAT_JSON, value=any_message.SerializeToString())
    ...
    '''    
    def test_unpack_given_wrong_upayloadformat_returns_none(self):
        original_msg: Message = BoolValue(value=False)
        upayload: UPayload = UPayload(format=UPayloadFormat.UPAYLOAD_FORMAT_PROTOBUF_WRAPPED_IN_ANY, value=original_msg.SerializeToString())
        
        unpacked_msg: BoolValue = self.builder.unpack(upayload, BoolValue)
