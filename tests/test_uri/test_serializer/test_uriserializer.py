...
from uprotocol.proto.core.usubscription.v3.usubscription_pb2 import DESCRIPTOR as USubscriptionFileDescriptor
from uprotocol.proto.uprotocol_options_pb2 import notification_topic as Notification_Topic
from uprotocol.proto.uprotocol_options_pb2 import UServiceTopic
from uprotocol.proto.uri_pb2 import UResource

from google.protobuf.descriptor import ServiceDescriptor, FileDescriptor, FieldDescriptor
...
class TestUriSerializer(unittest.TestCase):
    ...
    def test_build_resolved_full_information_compare_with_id(self):
        ...
        expected_longuri_given_id_uathority: str = "//1G1YZ23J9P5800001.veh.gm.com/core.usubscription/3/SubscriptionChange#Update"
    ...
    def test_build_resolved_full_information_compare_with_ipv6(self):
        ...
        expected_microuri_given_ipv6_uathority = bytearray(b'\x01\x02\x80\x00\x00\x00\x03\x00 \x01\r\xb8\x85\xa3\x00\x00\x00\x00\x8a.\x03ps4')
