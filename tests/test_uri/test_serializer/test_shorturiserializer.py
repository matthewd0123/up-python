...
class ShortUriSerializerTest(unittest.TestCase):
    ...
    def test_creating_short_uri_serializer(self):
        uri = UUri(entity=UEntity(id = 1, version_major=1), resource=UResourceBuilder.for_rpc_response())
    ...
    def test_creating_short_uri_serializer_with_method(self):
        uri = UUri(entity=UEntity(id = 1, version_major=1), resource=UResourceBuilder.for_rpc_request(10))
        str_uri = ShortUriSerializer().serialize(uri)
    ...
    def test_creating_short_uri_serializer_with_ip_authority(self):
        ...
        uri = UUri(entity=UEntity(id = 1, version_major=1), authority=UAuthority(ip=ip_bytes), resource=UResourceBuilder.from_id(20000))
        str_uri = ShortUriSerializer().serialize(uri)
    ...
    def test_short_serialize_with_invalid_ip_address(self):
        uri = UUri(entity=UEntity(id=1, version_major=1), authority=UAuthority(ip=b"34823748273"))
    ...
    def test_short_serialize_with_authority_only_name(self):
        uri = UUri(entity=UEntity(id=1, version_major=1), authority=UAuthority(name="mypc"))
        uri_string = ShortUriSerializer().serialize(uri)
        self.assertEqual(uri_string, "")
    ...
    def test_short_deserialize_with_remote_authority_ip_and_too_many_parts(self):
    ...
    def test_short_deserialize_with_remote_authority_and_invalid_characters_for_resource_id(self):
